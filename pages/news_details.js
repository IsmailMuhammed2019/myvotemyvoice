            ...
            <div className="col-md-9">
              <div className="blog_1dt">
                <div className="blog_1dt1">
                  ...
                  <div className="blog_1dt1i bg-light p-4 text-center">
                ...
                <div className="blog_1d2 mt-4">
                  <div className="blog_1d2m row">
                    ...
                    <div className="col-md-6">
                      <div className="blog_1d2r text-end">
                      ...
                      <div className="blog_h1i shadow_box">
                        <div className="blog_h1i1 position-relative">
                          <div className="blog_h1i1i">
                            <div className="grid clearfix">
                              <figure className="effect-jazz mb-0">
                                <Link href="#"><Image src="/Image/15.jpg" className="w-100" alt="Image25" width={500} height={300} /></Link>
                              </figure>
                            </div>
                          </div>
                      ...
                      <div className="blog_h1i shadow_box">
                        <div className="blog_h1i1 position-relative">
                          <div className="blog_h1i1i">
                            <div className="grid clearfix">
                              <figure className="effect-jazz mb-0">
                                <Link href="#"><Image src="/Image/true.jpg" className="w-100" alt="Image25" width={500} height={300} /></Link>
                              </figure>
                            </div>
                          </div>
                          <div className="blog_h1i1i1 text-center position-absolute w-100 h-100 bg_backo top-0">
                  ...
                  <div className="contact_1li row mt-4">
                    <div className="col-md-12">
                      <div className="contact_1lil">
                        ...
                        <h6 className="mb-0 mt-4"><Link href="#" className="button"><i className="fa fa-check-circle me-1"></i> Add Comment</Link></h6>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="footer_b1ri row">
                    <div className="col-md-4 col-4">
                      <div className="footer_b1ril">
                        <div className="grid clearfix">
                          <figure className="effect-jazz mb-0">
                            <Link href="blog_detail.html"><Image src="/Image/7.jpg" className="w-100" alt="abc" width={200} height={90} /></Link>
                          </figure>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="footer_b1ri row">
                    <div className="col-md-4 col-4">
                      <div className="footer_b1ril">
                        <div className="grid clearfix">
                          <figure className="effect-jazz mb-0">
                            <Link href="blog_detail.html"><Image src="/Image/8.jpg" className="w-100" alt="abc" width={200} height={90} /></Link>
                          </figure>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="footer_b1ri row">
                    <div className="col-md-4 col-4">
                      <div className="footer_b1ril">
                        <div className="grid clearfix">
                          <figure className="effect-jazz mb-0">
                            <Link href="blog_detail.html"><Image src="/Image/9.jpg" className="w-100" alt="abc" width={200} height={90} /></Link>
                          </figure>
                        </div>
                      </div>
                    </div>
