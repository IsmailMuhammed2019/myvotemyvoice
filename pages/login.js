    ...
    <Header />
      ...
      <section id="login" className="p_3">
        <div className="container-xl">
          <div className="row">
            <div className="col-md-12">
              <div className="login_1 p-4 mx-auto">
                <h3 className="col_red">Login</h3>
                <p className="center_sm">Login with your account</p>
                ...
                <h6 className="mt-4 mb-0 center_sm">
                  <Link className="button" href="#">Login <i className="fa fa-sign-in ms-1"></i></Link>
                </h6>
                <p className="mt-4 mb-0">Don't have an account? <Link className="col_red" href="register.html">Register</Link></p>
              </div>
            </div>
          </div>
        </div>
